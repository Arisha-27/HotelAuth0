"""
Lunaris Hospitality OS - FastAPI Entry Point
...
async def lifespan(app: FastAPI):
    ...
    logger.info("═" * 60)
    logger.info("🚀  Lunaris Phase 3+5 — All Systems READY")
    logger.info("═" * 60)

    yield  # Application runs

    logger.info("🛑 Shutting down Lunaris Backend...")
...
app = FastAPI(
    ...
    description=(
        "Lunaris Hospitality OS — Research-Grade Multi-Agent Hotel Chain Operating System\n\n"
