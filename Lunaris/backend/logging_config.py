"""
Structured JSON logging configuration for Lunaris Hospitality OS.
...
def setup_logging(log_level: str = "INFO", log_file: str = "logs/lunaris.log") -> None:
    ...
    root_logger = logging.getLogger("lunaris")
...
def get_logger(name: str) -> logging.Logger:
    """Get a child logger under the 'lunaris' namespace."""
    return logging.getLogger(f"lunaris.{name}")
