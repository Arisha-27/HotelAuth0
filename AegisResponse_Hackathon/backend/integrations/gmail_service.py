...
logger = logging.getLogger("ahos.integrations.gmail")
        ...
        <div style="max-width: 600px; margin: auto; background: #16213e; border-radius: 12px; overflow: hidden; border: 1px solid {template['color']}40;">
            <div style="background: {template['color']}; padding: 20px; text-align: center;">
                <h1 style="margin: 0; color: white; font-size: 24px;">
                    {template['icon']} Aegis Hospitality OS
                </h1>
            ...
            <div style="background: #0a0a23; padding: 12px; text-align: center; font-size: 11px; color: #555;">
                Aegis Hospitality OS &bull; Secured by Auth0 Token Vault &bull; AI-Powered Operations
            </div>
        </div>
    </body>
    </html>
...
class GmailService:
    """
    Gmail integration for AHOS alerts.
    ...
    def __init__(self):
        ...
        self.sender_email = os.getenv("GMAIL_SENDER_EMAIL", "aegis-os@aegis-hospitality.com")
