...
class Scope(str, Enum):
    """All OAuth2 scopes defined in the AHOS API."""
...
class AgentRole(str, Enum):
    """Hierarchical agent roles in the AHOS system."""
