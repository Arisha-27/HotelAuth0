...
logger = logging.getLogger("ahos.database")

DB_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "ahos.db")
...
class HotelDatabase:
    ...
    def _seed_data(self):
        ...
        with self._get_conn() as conn:
            ...
            # ── Hotels ──
            hotels = [
                ("hotel-downtown", "Aegis Downtown", "123 Business Ave", "New York", "USA", 30, 5),
                ("hotel-airport", "Aegis Airport Gateway", "1 Terminal Dr", "Chicago", "USA", 45, 4),
                ("hotel-resort", "Aegis Beach Resort", "500 Ocean Blvd", "Miami", "USA", 60, 5),
            ]
            conn.executemany(
