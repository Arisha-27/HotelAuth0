...
This software was developed for a controlled **Hackathon Environment**. While comprehensive security abstractions (HITL, Audit Logging, Middleware limits) are theoretically implemented, **this should not be deployed in a Production Hotel Environment without further penetration testing and hardening.**
